...
// Função implementada em display.c
// void* thread_exibir_info(void* arg);

// Stubs das funções de recursos (implementação básica)
int alocar_bancada(EstadoJogo* estado, int tripulante_id) {
    (void)estado; (void)tripulante_id; // Evitar warning
...
void liberar_bancada(EstadoJogo* estado, int bancada_id) {
    (void)estado; (void)bancada_id; // Evitar warning
    // Não implementado ainda
}

void liberar_cozinha(EstadoJogo* estado, int cozinha_id) {
    (void)estado; (void)cozinha_id; // Evitar warning
    // Não implementado ainda
}